...
Takes the Url in browser and dynamically responds to it.

1. How would you explain form validation to someone who has never programmed before?

Validation ensures that form inputs are entered correctly. For example, for an email field it makes sure that the email is in the correct format.

1. In 1-2 sentences, define end to end testing.

End to end testing tests the app from the beginning to end of the users experience to make sure everything is working properly.
